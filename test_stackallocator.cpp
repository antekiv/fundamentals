...
void TestExceptionSafety() {
    ...
    try {
        ...
        std::cout << "ctor: " << Accountant::ctor_calls << std::endl;
        std::cout << "dtor: " << Accountant::dtor_calls << std::endl;
...
int main() {
...

    {
        ...
        //template <typename Alloc = std::allocator<int>>
        //Alloc alloc = Alloc()
        List<int, StackAllocator<int, 200'000>> lst(alloc);
        SimpleAllocator<int> salloc;
        BasicListTest(salloc);
